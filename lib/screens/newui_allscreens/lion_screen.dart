...
class LionAppbarScreen extends StatefulWidget {
  const LionAppbarScreen({Key key}) : super(key: key);

  @override
  State<LionAppbarScreen> createState() => _LionAppbarScreenState();
}

class _LionAppbarScreenState extends State<LionAppbarScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    isSecondCount = 0;
    return Scaffold(
      backgroundColor: Color(0xffF9AC50),
      appBar: AppBar(
        ...
        title: Padding(
          ...
          child: Row(
            children: [
              ...
              Spacer(),
              Image.asset("assets/images/righteyes.png", height: 23, width: 29),
            ],
          ),
        ),
      ),

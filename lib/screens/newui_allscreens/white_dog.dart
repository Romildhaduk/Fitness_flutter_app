...
class WhiteDogScreen extends StatefulWidget {
  const WhiteDogScreen({Key key}) : super(key: key);

  @override
  State<WhiteDogScreen> createState() => _WhiteDogScreenState();
}

class _WhiteDogScreenState extends State<WhiteDogScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    isSecondCount = 0;
    return Scaffold(
      backgroundColor: Color(0xffFFB3A1),
      appBar: AppBar(

...
class TigerAppbarScreen extends StatefulWidget {
  const TigerAppbarScreen({Key key}) : super(key: key);

  @override
  State<TigerAppbarScreen> createState() => _TigerAppbarScreenState();
}

class _TigerAppbarScreenState extends State<TigerAppbarScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    isSecondCount = 0;
    return Scaffold(
      backgroundColor: Color(0xffF46831),
      appBar: AppBar(
        ...
        title: Column(
          children: [
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  Spacer(),
                  Image.asset("assets/images/righteye.png",
                      height: 23, width: 29),
                ],
              ),
            ),
            Row(
              ...
              children: [
                Image.asset("assets/images/Sharp2left.png",
                    height: 23, width: 29),
                Spacer(),
                Image.asset("assets/images/sharp3right.png",
                    height: 23, width: 29),
              ],
            )
          ],

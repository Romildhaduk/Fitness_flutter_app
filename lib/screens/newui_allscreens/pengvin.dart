...
class PengvinScreen extends StatefulWidget {
  const PengvinScreen({Key key}) : super(key: key);

  @override
  State<PengvinScreen> createState() => _PengvinScreenState();
}

class _PengvinScreenState extends State<PengvinScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    isSecondCount = 0;
    return Scaffold(
      backgroundColor: Color(0xff3A2127),
      appBar: AppBar(

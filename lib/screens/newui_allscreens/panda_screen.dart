...
class PandaAppbarScreen extends StatefulWidget {
  const PandaAppbarScreen({Key key}) : super(key: key);

  @override
  State<PandaAppbarScreen> createState() => _PandaAppbarScreenState();
}

class _PandaAppbarScreenState extends State<PandaAppbarScreen> {

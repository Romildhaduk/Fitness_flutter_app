...
class BlackDogAppbarScreen extends StatefulWidget {
  const BlackDogAppbarScreen({Key key}) : super(key: key);

  @override
  State<BlackDogAppbarScreen> createState() => _BlackDogAppbarScreenState();
}

class _BlackDogAppbarScreenState extends State<BlackDogAppbarScreen> {
